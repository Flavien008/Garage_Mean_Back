...
const {
  ajouterDetails, findReparation, getReparationVoiture ,facturerEtat, getReparationVoitureByEtat,updateEtat,setPrix,updateAvancement,updatedatedebut,updatedatefin
...
router.route("/updatedatefin/:id").post(auth,updatedatefin); 
